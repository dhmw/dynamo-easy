 ...
 */
var MAX_REQUEST_ITEM_COUNT = 10;
/**
 * Request class for the TransactGetItems operation. Read up to 10 items from one or more tables in a transaction.
 */
var TransactGetRequest = /** @class */ (function () {
    function TransactGetRequest(dynamoDB) {
        var _this = this;
        this.tables = [];
        this.mapResponse = function (response) {
            var Items = response.Responses && Object.keys(response.Responses).length
                ? response.Responses.map(function (item, ix) { return fromDb(item.Item, _this.tables[ix]); })
                : [];
            return {
    ...
    Object.defineProperty(TransactGetRequest.prototype, "dynamoDB", {
        get: function () {
     ...
     */
    TransactGetRequest.prototype.forModel = function (modelClazz, key) {
     ...
     */
    TransactGetRequest.prototype.returnConsumedCapacity = function (level) {
     ...
     */
    TransactGetRequest.prototype.execNoMap = function () {
     ...
     */
    TransactGetRequest.prototype.execFullResponse = function () {
     ...
     */
    TransactGetRequest.prototype.exec = function () {
        return this.dynamoDBWrapper
            .transactGetItems(this.params)
            .then(this.mapResponse)
            .then(function (r) { return r.Items; });
    };
    return TransactGetRequest;
}());
export { TransactGetRequest };
