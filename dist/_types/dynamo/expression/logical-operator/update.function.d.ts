 ...
 */
export declare function update2<T, K extends keyof T>(modelConstructor: ModelConstructor<T>, attributePath: K): UpdateExpressionDefinitionChainTyped<T, K>;
/**
 ...
 * ```
 */
export declare function update<T>(attributePath: keyof T): UpdateExpressionDefinitionChain;
/**
 * Use this method when accessing a nested attribute of a model
 */
export declare function update(attributePath: string): UpdateExpressionDefinitionChain;
