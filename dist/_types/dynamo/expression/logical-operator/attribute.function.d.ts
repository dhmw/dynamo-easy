...
import { ConditionExpressionDefinitionChain, ConditionExpressionDefinitionChainTyped } from '../type/condition-expression-definition-chain';
/**
 ...
 */
export declare function attribute2<T, K extends keyof T>(modelConstructor: ModelConstructor<T>, attributePath: K): ConditionExpressionDefinitionChainTyped<T, K>;
/**
 ...
 * ```
 */
export declare function attribute<T>(attributePath: keyof T): ConditionExpressionDefinitionChain;
/**
 * Use this method when accessing a nested attribute of a model
 */
export declare function attribute(attributePath: string): ConditionExpressionDefinitionChain;
