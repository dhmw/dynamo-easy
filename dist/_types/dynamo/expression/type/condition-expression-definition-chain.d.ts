...
export declare type ConditionExpressionDefinitionChain = ConditionFunctions<any, ConditionExpressionDefinitionFunction>;
export declare type ConditionExpressionDefinitionChainTyped<T, K extends keyof T> = ConditionFunctions<T[K], ConditionExpressionDefinitionFunction>;
export declare type RequestConditionFunctionTyped<R extends ConditionalParamsHost, T, K extends keyof T> = ConditionFunctions<T[K], R>;
export declare type RequestConditionFunction<R extends ConditionalParamsHost, T> = ConditionFunctions<any, R>;
export {};
