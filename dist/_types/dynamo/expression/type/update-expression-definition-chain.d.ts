...
export declare type UpdateExpressionDefinitionChainTyped<T, K extends keyof T> = UpdateFunctions<T[K], UpdateExpressionDefinitionFunction>;
export declare type UpdateExpressionDefinitionChain = UpdateFunctions<any, UpdateExpressionDefinitionFunction>;
/**
 * @hidden
 */
export declare type RequestUpdateFunction<R extends ConditionalParamsHost, T, K extends keyof T> = UpdateFunctions<T[K], R>;
