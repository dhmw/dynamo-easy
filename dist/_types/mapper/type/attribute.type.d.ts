 ...
 * @module mapper
 */
export declare type Attribute = StringAttribute | NumberAttribute | BinaryAttribute | StringSetAttribute | NumberSetAttribute | BinarySetAttribute | MapAttribute | ListAttribute<any> | NullAttribute | BooleanAttribute;
/**
 ...
 */
export declare type Attributes<T = {}> = Record<keyof T | string, Attribute>;
/**
